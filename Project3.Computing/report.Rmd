...
```{r read read.csv}
system.time(dat_csv <- read.csv(here("Desktop", "ss13hus.csv.bz2")))
```

```{r read scan}
system.time(dat_scan <- scan(here("Desktop", "ss13hus.csv.bz2"), what="character", quiet = TRUE))
```

```{r read readLines}
system.time(dat_lines <- readLines(here("Desktop", "ss13hus.csv.bz2")))
```
...
system.time(dat_sub_csv <- read.csv(here("Desktop", "ss13hus_subset.csv")))
```

```{r read_subset data.table}
system.time(dat_sub_dt <- data.table(here("Desktop", "ss13hus_subset.csv")))
```

```{r read_subset ff}
system.time(dat_sub_ff <- ff(here("Desktop","ss13hus_subset.csv")))
```
