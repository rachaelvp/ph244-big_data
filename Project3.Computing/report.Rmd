...
system.time(dat_csv <- read.csv(here("Project3.Computing","bigdata", "ss13hus.csv.bz2")))

system.time(dat_scan <- scan(here("Project3.Computing", "bigdata", "ss13hus.csv.bz2"), what="character", quiet = TRUE))

system.time(dat_lines <- readLines(here("Project3.Computing", "bigdata", "ss13hus.csv.bz2")))
