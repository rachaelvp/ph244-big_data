...
system.time(dat_csv <- read.csv(file=here("Project3.Computing","bigdata", "ss13hus.csv.bz2")))

system.time(scan(dat_scan <- file=here("Project3.Computing", "bigdata", "ss13hus.csv.bz2")))

system.time(dat_lines <- readLines(file=here("Project3.Computing", "bigdata", "ss13hus.csv.bz2")))
...
write.csv(dat_sub, file = here("Project3.Computing", "bigdata", "ss13hus_subset.csv"))
...
system.time(dat_sub_csv <- read.csv(here("Project3.Computing", "bigdata", "ss13hus_subset.csv")))

system.time(dat_sub_dt <- data.table(here("Project3.Computing", "bigdata", "ss13hus_subset.csv")))

system.time(dat_sub_ff <- ff(here("Project3.Computing", "bigdata", "ss13hus_subset.csv")))
...
dat_sub$FINADJ <- dat_sub$FINCP*dat_sub$ADJINC

ggplot(dat_sub, aes(x = BDSP, y = FINADJ)) + geom_point() + stat_smooth(method = "loess", se = TRUE)
